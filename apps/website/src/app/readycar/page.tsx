      ...
      <div className={styles.inboxContainer}>
        ...
        {showNewMessage === 'import' && (
          <ImportSpreadsheetModal
            ...
            onComplete={() => { setShowNewMessage(false); fetchConversations(); queryClient.invalidateQueries({ queryKey: ['leads', 'readycar'] }); queryClient.invalidateQueries({ queryKey: ['dashboard', 'readycar'] }); }}
          />
        )}
