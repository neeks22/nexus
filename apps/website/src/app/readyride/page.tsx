...
function InboxContent(): React.ReactElement {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        console.error('[readyride] Agent status check error:', err instanceof Error ? err.message : 'unknown');
      }
    })();
  }, [activeConversation?.phone]);
  ...
  async function toggleAgent(): Promise<void> {
    ...
    try {
      ...
      console.error('[readyride] Agent toggle error:', err instanceof Error ? err.message : 'unknown');
    }
