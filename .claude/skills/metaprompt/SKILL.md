---
name: metaprompt
description: "Anthropic's official metaprompt for generating high-quality agent prompts. Feed it a task description and it outputs a production-ready, structured prompt with XML tags, chain-of-thought, and examples."
user-invocable: true
---

# Metaprompt — Prompt Generator

Generate any new agent prompt by describing the task. This is the EXACT pattern Anthropic uses in their Console.

## Usage

Invoke this skill with a task description, and it will produce a complete, structured prompt template.
...
[Anthropic Metaprompt Cookbook (Official)](https://platform.claude.com/cookbook/misc-metaprompt)
